...
#ifndef __EMAC_88E6063_H 
#define __EMAC_88E6063_H 
...
#define PHY_REG_SSR			0x11				/* Specific Status Register					 */

#define DEVICE_DEF_ADR    	0x1000      /* Default PHY device address        */

void write_PHY (U32 PhyReg, U16 Value);
U16 read_PHY (U32 PhyReg);

#endif /* end __EMAC_88E6063_H */
/****************************************************************************
                            End Of File
****************************************************************************/
